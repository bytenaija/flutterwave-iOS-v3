...
public class FlutterwavePayViewController: BaseViewController {
    ...
    func configureMpesaView(){
        flutterwaveMpesaClient.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func configureMobileMoneyGhana(){
        flutterwaveMobileMoney.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func configureMobileMoneyUganda(){
        flutterwaveMobileMoneyUganda.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func configureMobileMoneyZambia(){
        flutterwaveMoneyZM.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func configureMobileMoneyFranco(){
        flutterwaveMobileMoneyFR.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func configureMobileMoneyRwanda(){
        flutterMobileMoneyRW.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
...
//        }
    ...
    func gbpAccountCallbacks(){
        flutterwaveUKAccountClient.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func accountCallbacks(){
        flutterwaveAccountClient.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
    ...
    func cardCallbacks(){
        flutterwaveCardClient.transactionReference = FlutterwaveConfig.sharedConfig().transactionRef
