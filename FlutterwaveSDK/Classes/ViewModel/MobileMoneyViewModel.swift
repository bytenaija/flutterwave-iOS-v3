...
class MobileMoneyViewModel: BaseViewModel{
    ...
    func rwandaMoney(amount: String, network:String, phoneNumber: String) {
        let request = RwandaMobileMoneyRequest(txRef: FlutterwaveConfig.sharedConfig().transactionRef, amount: amount, currency: FlutterwaveConfig.sharedConfig().currencyCode, network: network, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
    ...
    func ugandaMoney(amount: String, phoneNumber: String) {
        let request = UgandaMobileMoneyRequest(txRef: FlutterwaveConfig.sharedConfig().transactionRef, amount: amount, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, currency: FlutterwaveConfig.sharedConfig().currencyCode, network: "MTN")
    ...
    func zambiaMoney(amount: String, phoneNumber: String, network: String) {
        let request = ZambiaMobileMoneyRequest(txRef: FlutterwaveConfig.sharedConfig().transactionRef, amount: amount, currency: FlutterwaveConfig.sharedConfig().currencyCode, network: network, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
    ...
    func mpesaMoney(amount: String, phoneNumber: String) {
        let request = MpesaRequest(txRef: FlutterwaveConfig.sharedConfig().transactionRef, amount: amount, currency: FlutterwaveConfig.sharedConfig().currencyCode, email:FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
    ...
    func francoPhoneMoney(amount: String, phoneNumber: String, country:String) {
        let request = FrancophoneMobileMoneyRequest(txRef: FlutterwaveConfig.sharedConfig().transactionRef, amount: amount, currency: FlutterwaveConfig.sharedConfig().currencyCode, email: FlutterwaveConfig.sharedConfig().email, phoneNumber: phoneNumber, country: country, fullname: "\(FlutterwaveConfig.sharedConfig().firstName.orEmpty()) \(FlutterwaveConfig.sharedConfig().lastName.orEmpty())")
