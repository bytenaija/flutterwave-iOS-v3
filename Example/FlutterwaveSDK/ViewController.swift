...
class ViewController: UIViewController, FlutterwavePayProtocol {
    ...
    @objc func showExample(){
        ...
        config.transactionRef = "IOS-TEST" // This is a unique reference, unique to the particular transaction being carried out. It is generated when it is not provided by the merchant for every transaction.
